    ...
    <div class="otp-shell">
        ...
        <div class="otp-content">
            <div class="otp-card">
                ...
                <form method="POST" action="{{ route('password.otp.verify') }}" class="otp-form" id="otpForm">
                    @csrf
                ...
                <a href="{{url('login')}}" style="display:block; margin-top:6px; margin-bottom: 0; text-align:center; font-size:12px; font-weight:600; color: #888d94; text-decoration:none;">
                    Cancel registration
                </a>

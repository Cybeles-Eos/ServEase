                ...
                <form class="provider-login-main__form--fields">
                    ...
                    <div class="plm-ff-group">
                        ...
                        <div class="plm-ff-group-pass">
                            <input type="password" id="password" placeholder="e. g. name@gmail.com" required autocomplete="current-password">
                    ...
                    <p class="plm-ff-cta">Don't have account yet? <a href="{{url('provider/signin')}}">Join now</a></p>
                </form>
            </div>

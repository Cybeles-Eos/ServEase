                            ...
                            <div class="pbmdr-cb-box">
                                ...
                                <div class="pbmdr-cb-box__det">
                                    <div class="pbmdr-cb-boxdet-p">
                                        <img src="{{asset($request->bookingInfo->customer['profile_image'] ?? 'images/user.png')}}" class="pbmdr-cb-boxdet-p__pfp" alt="profile-image">
                                        <div class="pbmdr-cb-boxdet-p__pfp-d">
                                            <p class="pbmdr-cb-boxdet-p__pfp-d__name">{{$request->bookingInfo['lname']}} {{$request->bookingInfo['fname']}}</p>
                                            <a href="#" class="pbmdr-cb-boxdet-p__pfp-d__num">{{$request->bookingInfo['number']}}</a>
                                            <a href="#" class="pbmdr-cb-boxdet-p__pfp-d__email">{{$request->bookingInfo['email']}}</a>
                                        </div>
                                    </div>
                                </div>

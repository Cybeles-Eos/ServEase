...
@section('content')
    ...
    <main class="main-dash-uix dash-sp provider--setting">
        <form id="provider-setting-form" action="{{ route('provider.setting.update') }}" class="provider--setting--main" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="csm-left">
            ...
            <div class="csm-right">
                ...
                <div id="provider-password-fields" class="setting-password-fields {{ $showPasswordFields ? 'is-visible' : '' }}">
...
@push('extrascripts')
    ...
    <script>
        (function () {
            var form = document.getElementById('provider-setting-form');
            var toggle = document.getElementById('provider-change-password-toggle');
            var wrap = document.getElementById('provider-password-fields');

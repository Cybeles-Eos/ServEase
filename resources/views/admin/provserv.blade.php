                        ...
                        @foreach ($services as $service)
                            <div class="provider-stbl-main-c__tbody">
                                ...
                                <div class="prvstble-mctb-act">
                                    ...
                                    <a href="#" class="prvstble-mctb-act__remove">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M5 11.9907L8.49533 8.49533M8.49533 8.49533L11.9907 5M8.49533 8.49533L5 5M8.49533 8.49533L11.9907 11.9907" stroke="white" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                    </a>
                                </div>
                            </div>

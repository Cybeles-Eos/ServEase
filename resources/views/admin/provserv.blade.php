            ...
            <div class="provider-stbl-main">
                <div class="provider-stbl-main-c">
                    ...
                    <div class="provider-stbl-main-c__tbody">
                        <div class="prvstble-mctb-id">#SRV-12003</div>
                        <div class="prvstble-mctb-name">{{ Str::limit('From minor leaks to major pipe repairs, our trusted Filipino plumbers deliver fast, safe, and professional service right at your doorstep. Whether it’s an emergency fix or routine maintenance, we make sure your water system runs smoothly and efficiently.', 60) }}</div>
                        <div class="prvstble-mctb-serv">Plumber</div>
                        <div class="prvstble-mctb-slug"><a href="{{url('')}}">https://servease/service/reliable -plumbing-solutions-for-every...</a></div>
                        <div class="prvstble-mctb-date">July 25, 2025</div>

                        ...
                        @foreach ($services as $service)
                            <div class="provider-stbl-main-c__tbody">
                                ...
                                <div class="prvstble-mctb-act">
                                    ...
                                    <a href="{{ route('provider.service.reviews', $service->id) }}"
                                    title="Service Reviews"
                                    style="display:inline-flex;align-items:center;justify-content:center;">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                                            <path d="M4 5.5C4 4.12 5.12 3 6.5 3H17.5C18.88 3 20 4.12 20 5.5V13.5C20 14.88 18.88 16 17.5 16H9L5 20V16.2C4.42 15.97 4 15.39 4 14.7V5.5Z"
                                                stroke="#535353"
                                                stroke-width="1.6"

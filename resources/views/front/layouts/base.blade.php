...
<head>
    ...
    <meta property="og:image" content="{{ platformMetaImageUrl() }}" />
    ...
    <meta name="twitter:image" content="{{ platformMetaImageUrl() }}" />

    {{-- Icons --}}
    <link rel="apple-touch-icon" sizes="180x180" href="{{ platformFaviconUrl() }}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ platformFaviconUrl() }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ platformFaviconUrl() }}">
    <link rel="manifest" href="{{ asset('images/icons/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ platformFaviconUrl() }}" color="#5bbad5">
